...
if __name__ == '__main__':
    logging.basicConfig(filename='/var/log/moxi.log.'+str(os.getpid()), format='%(asctime)s %(levelname)s %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p', level=logging.DEBUG)
